        ...
        <section className="hero">
          <div className="container">
            ...
            <p className="hero-value-prop">
              Build real-world social confidence through structured lessons and
              daily practice.
            </p>
            ...
            <p className="hero-compliance">
              Subscription required for full access. Cancel anytime.
            </p>
            <div className="hero-image">
              <img
                src="/The Physical Approach.png"
                alt="The Physical Approach"
              />
            </div>
          </div>
        </section>
          ...
          <div className="container">
            ...
            <div className="features-grid">
              ...
              <div className="feature-card">
                ...
                <ul className="feature-list">
                  <li>
                    Users can log real world social encounters in a simple modal
                  </li>
                  <li>Tracks attempts and reflections over time</li>
                  <li>
                    Profile page shows historical approaches and progress trends
                  </li>
              ...
              <div className="feature-card">
                ...
                <ul className="feature-list">
                  ...
                  <li>
                    Delivered as short, structured lessons designed for daily
                    use
                  </li>
                </ul>
              </div>
            ...
            <div className="steps">
              ...
              <div className="step">
                ...
                <p className="step-description">
                  Practice games and real world encounters
                </p>
              </div>
              <div className="step">
                <h3 className="step-title">Track</h3>
                <p className="step-description">
                  Profile progress history and insights
                </p>
              </div>
            </div>
          </div>
